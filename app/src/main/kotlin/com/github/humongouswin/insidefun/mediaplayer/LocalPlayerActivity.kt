 ...
 */
package com.github.humongouswin.insidefun.mediaplayer
...
import com.github.humongouswin.insidefun.expandedcontrols.ExpandedControlsActivity
import com.github.humongouswin.insidefun.settings.CastPreference
import com.github.humongouswin.insidefun.utils.CustomVolleyRequest.Companion.getInstance
import com.github.humongouswin.insidefun.utils.MediaItem
import com.github.humongouswin.insidefun.utils.MediaItem.Companion.fromBundle
import com.github.humongouswin.insidefun.utils.Utils.formatMillis
import com.github.humongouswin.insidefun.utils.Utils.getDisplaySize
import com.github.humongouswin.insidefun.utils.Utils.isOrientationPortrait
import com.github.humongouswin.insidefun.utils.Utils.showErrorDialog
...
class LocalPlayerActivity : AppCompatActivity() {
    ...
    private var mCastButton: MediaRouteButton? = null
    ...
    private fun initCast() {
        try {
            ...
            CastButtonFactory.setUpMediaRouteButton(this, mCastButton!!)
            castPlayer = CastPlayer(CastContext.getSharedInstance(application))
            castPlayer?.setSessionAvailabilityListener(object : SessionAvailabilityListener {
                override fun onCastSessionAvailable() {
                    if (isVideoCastingStart) {
                        castPlayer?.release()
                        isVideoCastingStart = false
                    } else {
                         mVideoView!!.pause()



                        var mMediaMetadata = com.google.android.exoplayer2.MediaItem.Builder().setUri(mSelectedMedia!!.url.toString())
                            .setMediaId(mSelectedMedia!!.title.toString())
                            .setMimeType(MimeTypes.getMediaMimeType(mSelectedMedia!!.url.toString()))
                            .build()
                        isVideoCastingStart = true
                        castPlayer?.setMediaItem(mMediaMetadata, 0)
            ...
            Toast.makeText(this, "RuntimeException:${e.localizedMessage}", Toast.LENGTH_SHORT).show()
        }
    }
    ...
    private fun loadViews() {
        ...
        mCastButton = findViewById<MediaRouteButton>(R.id.castButton) as MediaRouteButton
    ...
    private fun buildMediaInfo(): MediaInfo? {
        ...
        return mSelectedMedia!!.url?.let {
            MediaInfo.Builder(it)
                ...
                .setStreamDuration(mSelectedMedia!!.duration.toLong() * 1000)
                .build()
        }
    }
